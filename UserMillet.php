...
<center><div style="height:1400px;width:700px;float:center">
  <h1><b> Millet :</b></h1>
  <img src="F:\html pro\intertopics\pesticides_sub\pic12.jpg" alt="Sugercane" style="height:600px;width:800px;float:center">
  ...
  <p style="font-size:20px">   There are two types of millets commonly popular by names.</p>
  <ul style="float:left;color:red">
    <li>Pearl</li><br>
    <li>Finger</li><br>
  </ul><br><br><br><br><br>
  <p style="font-size:20px">   The most widely grown millet is pearl millet, which is an important crop in India and parts of Africa. Finger millet, proso millet, and foxtail millet are also important crop species. In the developed world, millets are less important. For example, in the United States, only proso millet is significant, and it is mostly grown for bird seed.</p>
  <p style="font-size:20px">   While millets are indigenous to many parts of the world, it is believed that they had an evolutionary origin in tropical western Africa, as that is where the greatest number of both wild and cultivated forms exist. Millets have been important food staples in human history, particularly in Asia and Africa. They have been in cultivation in East Asia for the last 10,000 years.</p>
  </ul>
</div>
</center>
</div>
