...
<center><div style="height:1400px;width:700px;float:center">
  <h1><b> Uses :</b></h1>
  <p style="font-size:20px">   Pesticides are used to control organisms that are considered to be harmful.  </p>
  <h1>Uses</h1><br>
  <ul style="font-size:18px;">
    <li>Pesticides can prevent sickness in humans that could be caused bymoldy food or diseased produce. </li><br><br>
    <li>Herbicides can be used to clear roadside weeds, trees and brush. They can also kill invasive weedsthat may cause environmental damage. </li><br><br>
    <li>. Herbicides are commonly applied in ponds and lakes to control algae and plants such as water grasses that can interfere with activities like swimming and fishing and cause the water to look or smell unpleasant.</li><br><br>
    
  <p style="font-size:20px">   There are two levels of benefits for pesticide use, primary and secondary. Primary benefits are direct gains from the use of pesticides and secondary benefits are effects that are more long-term.</p>
  <h1>Primary benefits</h1><br>
  <p style="font-size:20px">   Controlling pests and plant disease vectorsImproved crop/livestock yields Improved crop/livestock quality Invasive species controlledControlling human/livestock disease vectorsand nuisance organismsHuman lives saved and suffering reduced Animal </p>
  <h1>Monetary</h1><br>
  <p style="font-size:20px">   Every dollar ($1) that is spent on pesticides for crops yields four dollars ($4) in crops saved. This means based that, on the amount of money spent per year on pesticides, $10 billion</p><br><br>
  </ul>
</div>
</center>
</div>
