...
<center><div style="height:1400px;width:1000px;float:center">
  <h1><b> Compound fertilizers :</b></h1>
  <p style="font-size:20px">   Compound fertilizers, which contain N, P, and K, can often be produced by mixing straight fertilizers. In some cases, chemical reactions occur between the two or more components. For example, monoammonium and diammonium phosphates, which provide plants with both N and P, are produced by neutralizing phosphoric acid (from phosphate rock) and ammonia :<br><br>NH3 + H3PO4 → (NH4)H2PO4 2 NH3 + H3PO4 → (NH4)2HPO4</p>
  <h2><b> A large commercial compost operation :</b></h2>
    <p style="font-size:20px">    The main "organic fertilizers" are peat,animal wastes, plant wastes from agriculture, and treated sewage sludge(biosolids).[citation needed] In terms of volume, peat is the most widely used organic fertilizer.[citation needed] This immature form of coal confers no nutritional value to the plants, but improves the soil by aeration and absorbing water. Animal sources include the products of the slaughter of animals.Bloodmeal, bone meal, hides, hoofs, and horns are typical components.[1] Organic fertilizer usually contain fewer nutrients, but offer other advantages as well as being appealing to those who are trying to practice "environmentally friendly" farming.</p>
    <p style="font-size:20px">    Other elements: calcium, magnesium, and sulfur</p>
  
    <p style="font-size:20px">    Calcium is supplied as superphosphate or calcium ammonium nitrate solutions.</p>
