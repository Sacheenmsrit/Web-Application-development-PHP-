...
<center><div style="height:1400px;width:900px;float:center">
  <h1><b> Binary NPK fertilizers :</b></h1>
  ...
  <h2><b> Binary (NP, NK, PK) fertilizers :</b></h2>
    ...
    <h2><b> Micronutrients :</b></h2>
    <p style="font-size:20px">    The main micronutrients include sources of iron, manganese, molybdenum, zinc, and copper. As for the macronutrients, these elements are provided as water-soluble salts. Iron presents special problems because it converts to insoluble (bio-unavailable) compounds at moderate soil pH and phosphate concentrations. For this reason, iron is often administered as achelate complex, e.g., the EDTA derivative. The micronutrient needs depend on the plant. For example, sugar beets appear to require boron, and legumes require cobalt.</p>
</div>
</center>
</div>
<div id="footer">
