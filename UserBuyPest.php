...
<div class="dropdown">
  ...
  <div class="dropdown-content">
    ...
    <a href="viewpestcart.php">View Cart</a>
...
<div class="img">
  <div class="desc"> Batch No :<?php echo $row["BatchNo"]?></div>
    <img src=<?php echo $row["URL"];?> alt="Forest" width="300" height="200">
  
  <div class="desc"> Description :<?php echo $row["DESCRIPTION"]?></div>
   <div class="desc" style="color:red;">MRP : <?php echo $row["PRICE"]?> /-</div>
   <div class="desc">Quantity : <?php echo $row["Quantity"]?>(In KG)</div>
   <form action="addkartpest.php">
	Enter Batch No :
	<input type="text" name="batch" placeholder="Enter Batch No" width="80%">
