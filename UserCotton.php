...
<center><div style="height:1400px;width:700px;float:center">
  <h1><b> Cotton :</b></h1>
  <img src="F:\html pro\intertopics\crops_sub\pic57.jpg" alt="Sugercane" style="height:400px;width:700px;float:center">
  <b><p style="font-size:20px">   <span style="color:chocolate;">Cotton </span> is a soft, fluffy staple <span style="color:red;">fiber</span> that grows in a <span style="color:red;">boll,</span> or protective case, around the seeds of cotton plants of the genus <span style="color:red;">Gossypiumin</span> the family of <span style="color:red;">Malvaceae.</span> The fiber is almost pure <span style="color:red;">cellulose.</span> Under natural conditions, the cotton bolls will tend to increase the dispersal of the seeds.<span style="color:red;">[clarification needed]</span>.
The fiber is most often spun into <span style="color:red;">yarn</span> or thread and used to make a soft, <span style="color:red;">breathable textile.</span> The use of cotton for fabric is known to date to prehistoric times; fragments of cotton fabric dated from 5000 BC have been excavated in Mexico and the Indus Valley Civilization in <span style="color:red;">Indian subcontinent</span> between 6000 BC and 5000 BC. Although cultivated since antiquity, it was the invention of the <span style="color:red;">cotton gin</span> that lowered the cost of production that led to its widespread use, and it is the most widely used <span style="color:red;">natural fiber</span> cloth in clothing today.
</p>
    <div style="background-color:linen;height:450px;width:250px;">
        <ul style="float:left">
          <h3 style="background-color:green"><pre><b>       Species:     </b></pre></h3>
          <li>Gossypium hirsutum</li><br>
          <li>Gossypium barbadense</li><br>
          <li>Gossypium arboreum</li><br>
          <li>Gossypium herbaceum</li><br>
          <h3 style="background-color:green"><pre><b>       Production:     </b></pre></h3>
          <li>Cotton gin</li><br>
          <li>Cotton mill</li><br>
          <li>Cotton picker</li><br>
          <li>Spinning jenny</li><br>
        </ul>
    </div>
  <p style="font-size:20px">   Current estimates for world production are about 25 million <span style="color:red;">tonnes</span> or 110 million bales annually, accounting for 2.5% of the world's arable land. China is the world's largest producer of cotton, but most of this is used domestically. The United States has been the largest exporter for many years. In the United States, cotton is usually measured in bales, which measure approximately 0.48 cubic meters (17 cubic feet) and weigh 226.8 kilograms (500 pounds). </p>
